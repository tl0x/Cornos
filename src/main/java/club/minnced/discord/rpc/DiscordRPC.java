...
public interface DiscordRPC extends Library {
	 ...
	 *
	 * @param applicationId
	 *            The ID for this RPC application, retrieved from the
	 *            <a href= "https://discordappc.com/developers/applications/me"
	 *            target="_blank">developer dashboard</a>
	 * @param handlers
	 *            Nullable instance of {@link DiscordEventHandlers}
	 * @param autoRegister
	 *            {@code true} to automatically call
	 *            {@link #Discord_RegisterSteamGame(String, String)} or
	 *            {@link #Discord_Register(String, String)}
	 * @param steamId
	 *            Possible steam ID of the running game
	 */
	void Discord_Initialize(@NotNull String applicationId, @Nullable DiscordEventHandlers handlers,
	 ...
	 * @param command
	 *            The command for the application startup, or {@code null} to use
