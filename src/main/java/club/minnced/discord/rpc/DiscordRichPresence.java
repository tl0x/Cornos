...
public class DiscordRichPresence extends Structure {
	private static final List<String> FIELD_ORDER = Collections.unmodifiableList(Arrays.asList("state", "details",
			...
			"partyId", "partySize", "partyMax", "matchSecret", "joinSecret", "spectateSecret", "instance", "buttons"));
	/**
	...
	/**
	 * The buttons to display on the users popout or profile, as JSON string <br>
	 * Example: [{"label":"bruh","url":"https://youtube.com/"}]
	 */
