...
public class AutoSign extends Module {
	...
	public AutoSign() {
		...
		type = (MConfMultiOption) this.mconf
				.add(new MConfMultiOption("mode", "noise", new String[]{"noise", "copypasta", "longlines", "custom"}));
		Module parent = this;
		EventHelper.BUS.registerEvent(EventType.ONPACKETHANDLE, event -> {
			...
			if (PE.packet instanceof SignEditorOpenS2CPacket && parent.isEnabled()) {
				...
				switch (type.value) {
					case "noise" :
						lines = new String[]{Rnd.rndBinStr(15), Rnd.rndBinStr(15), Rnd.rndBinStr(15),
								Rnd.rndBinStr(15)};
						break;
					case "copypasta" :
						lines = new String[]{"cornos is just", "the best client", "to ever exist", "its true"};
						break;
					case "longlines" :
						lines = new String[]{Rnd.rndBinStr(50), Rnd.rndBinStr(50), Rnd.rndBinStr(50),
								Rnd.rndBinStr(50)};
						break;
					case "custom" :
				...
				net.minecraft.network.packet.c2s.play.UpdateSignC2SPacket packet = new UpdateSignC2SPacket(p.getPos(),
