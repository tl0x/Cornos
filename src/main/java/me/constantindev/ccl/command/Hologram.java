...
public class Hologram extends Command {
    ...
    public static void spawnHologram(Vec3d pos, String text, boolean egg, boolean baby) {
        ItemStack is = getHoloStack(pos, text, egg, baby);
        Cornos.minecraft.player.inventory.addPickBlock(is);
    }

    public static ItemStack getHoloStack(Vec3d pos, String text, boolean egg, boolean baby) {
        ...
        if (egg) compoundTag.put("id", StringTag.of("minecraft:armor_stand"));
