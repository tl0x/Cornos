        ...
        for(int y = 0;y<256;y++) {
            ...
            for(int x = 0;x<16;x++) {
                for(int z = 0;z<16;z++) {
                    ...
                    if (bs.isOf(Blocks.AIR) || bs.isOf(Blocks.CAVE_AIR) || bs.isOf(Blocks.WATER) || bs.isOf(Blocks.LAVA)) continue;
                    ...
                    if (!mode.value.equals("legit")) {
                        ...
                        if (showParticles) Cornos.minecraft.interactionManager.attackBlock(bp1,Direction.DOWN);
                        else {
