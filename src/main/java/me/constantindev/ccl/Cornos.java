...
import me.constantindev.ccl.etc.manager.FriendsManager;
...
import me.constantindev.ccl.features.module.impl.external.ClientConfig;
...
public class Cornos implements ModInitializer {
    ...
    public static me.constantindev.ccl.features.module.impl.external.ClientConfig config;
    ...
    public void onInitialize() {
        ...
        ModuleRegistry.init();
        config = (me.constantindev.ccl.features.module.impl.external.ClientConfig) ModuleRegistry.search(ClientConfig.class);
