        ...
        switch (args[0].toLowerCase()) {
            case "add":
                try {
                    ...
                    Cornos.friendsManager.getFriends().put(name, new me.constantindev.ccl.etc.config.Friend(name, fakeName));
            ...
            case "remove":
                try {
                    String name = args[1];
                    for (Map.Entry<String, me.constantindev.ccl.etc.config.Friend> entry : Cornos.friendsManager.getFriends().entrySet()) {
