...
public class FunnyItemsScreen extends Screen {
    ...
    protected void init() {
        ...
        ButtonWidget enableStandAura = new ButtonWidget(5, 190, 200, 20, Text.of("Enable stand aura"), button -> {
        ...
        ButtonWidget lagmorstand = new ButtonWidget(210, 70, 200, 20, Text.of("32k Lagmor stand"), button -> {
            //{EntityTag:{id:"minecraft:area_effect_cloud",Particle:"barrier",Radius:16777216f,RadiusPerTick:0f,Duration:1310700,WaitTime:60}}
