...
public class HeadsScreen extends Screen {
    ...
    protected void init() {
        ...
        RoundedButtonWidget givePlayerHead = new RoundedButtonWidget(215, 20, 200, 20, Text.of("Give Player Head"), () -> {
        ...
        RoundedButtonWidget giveHdHead = new RoundedButtonWidget(215, 50, 200, 20, Text.of("Give HD Head"), () -> {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (ign.getText().isEmpty()) ign.setSuggestion("Player name");
        else ign.setSuggestion("");
        eduUrl.render(matrices, mouseX, mouseY, delta);
        if (eduUrl.getText().isEmpty()) eduUrl.setSuggestion("Minecraft edu URL");
        else eduUrl.setSuggestion("");
