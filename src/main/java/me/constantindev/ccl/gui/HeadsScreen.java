...
public class HeadsScreen extends Screen {
    ...
    protected void init() {
        ...
        ButtonWidget givePlayerHead = new ButtonWidget(215, 20, 200, 20, Text.of("Give Player Head"), button -> {
        ...
        ButtonWidget giveHdHead = new ButtonWidget(215, 50, 200, 20, Text.of("Give HD Head"), button -> {
