...
import me.constantindev.ccl.etc.ItemExploits;
import me.constantindev.ccl.features.command.impl.Hologram;
import me.constantindev.ccl.features.module.ModuleRegistry;
import me.constantindev.ccl.features.module.impl.exploit.HologramAura;
...
public class FunnyItemsScreen extends Screen {
    ...
    protected void init() {
        ...
        CustomButtonWidget crashFireball = new CustomButtonWidget(210, 20, 200, 20, Text.of("Server crash fireball"), () -> Cornos.minecraft.player.inventory.addPickBlock(ItemExploits.SERVER_CRASH_FIREBALL.get()));
        CustomButtonWidget blockban = new CustomButtonWidget(210, 45, 200, 20, Text.of("Blockban crash"), () -> Cornos.minecraft.player.inventory.addPickBlock(ItemExploits.BLOCKBAN.get()));
        CustomButtonWidget lagmorstand = new CustomButtonWidget(210, 70, 200, 20, Text.of("32k Lagmor stand"), () -> Cornos.minecraft.player.inventory.addPickBlock(ItemExploits.LAGMOR_STAND.get()));
        CustomButtonWidget cKitKickStand = new CustomButtonWidget(415, 20, 200, 20, Text.of("Kick stand"), () -> Cornos.minecraft.player.inventory.addPickBlock(ItemExploits.KICK_STAND.get()));
        CustomButtonWidget cTrollHelmet = new CustomButtonWidget(415, 45, 200, 20, Text.of("Troll helmet"), () -> Cornos.minecraft.player.inventory.addPickBlock(ItemExploits.NO_MOVE_HELMET.get()));
        CustomButtonWidget cNoEntityKill = new CustomButtonWidget(415, 70, 200, 20, Text.of("No Entity Kill"), () -> Cornos.minecraft.player.inventory.addPickBlock(ItemExploits.NO_ENTITY_KILL.get()));
