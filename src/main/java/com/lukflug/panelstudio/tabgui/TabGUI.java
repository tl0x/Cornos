...
/**
 * A {@link TabGUIContainer} that is also a {@link FixedComponent}. Should be
...
public class TabGUI extends TabGUIContainer implements FixedComponent {
	 ...
	 *
	 * @param title
	 *            caption for the TabGUI
	 * @param renderer
	 *            the renderer for the TabGUI
	 * @param animation
	 *            the animation for the TabGUI
	 * @param position
	 *            the initial position for the TabGUI
	 * @param width
	 *            the width of the TabGUI
	 */
