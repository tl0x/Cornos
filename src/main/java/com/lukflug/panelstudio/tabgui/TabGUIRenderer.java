...
public interface TabGUIRenderer {
	 ...
	 *            the current context
	 * @param offset
	 *            the vertical position of the text highlight
	 * @param height
	 *            the height of the text highlight and of single components
	 */
	 ...
	 *            the current context
	 * @param caption
	 *            caption of the child in question
	 * @param index
	 *            the index of the child in the container
	 * @param height
	 *            the height of a single child component
	 * @param active
	 *            whether the child component is active
	 */
