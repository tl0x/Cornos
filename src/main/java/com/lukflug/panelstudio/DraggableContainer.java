...
/**
 * Class for a {@link FixedComponent} that is also a
 * {@link CollapsibleContainer} (i.e. a Panel), that can be dragged by the user
 * using the mouse.
 *
 * @author lukflug
 */
public class DraggableContainer extends CollapsibleContainer implements FixedComponent {
	 ...
	 * @param renderer
	 *            {@link Renderer} for the container
	 * @param open
	 *            {@link Toggleable} to indicate whether the container is open or
	 *            closed
	 * @param animation
	 *            the animation for opening and closing the container
	 * @param toggle
	 *            the {@link Toggleable} to be toggled by the user
	 * @param position
	 *            the initial position of the container
	 * @param width
	 *            the width of the container
	 */
	public DraggableContainer(String title, String description, Renderer renderer, Toggleable open, Animation animation,
			Toggleable toggle, Point position, int width) {
