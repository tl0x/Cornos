...
public class FocusableComponent implements Component {
	 ...
	 *
	 * @param title
	 *            the caption for this component
	 * @param description
	 *            the description for this component
	 * @param renderer
	 *            the {@link Renderer} for this component
	...
	/**
	 * Updates the focus state. Set the height of this component to the height
	 * specified by {@link Renderer}.
	 */
	@Override
	...
	/**
	 * If the button is being pressed, update focus state to hover state and call
	 * {@link #handleFocus(Context, boolean)}.
	 *
	 * @param context
	 *            the {@link Context} for the component
	 * @param button
	 *            the mouse button state that changed
