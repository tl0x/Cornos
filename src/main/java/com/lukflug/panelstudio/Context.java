...
public final class Context {
	...
	/**
	 * The size of the component. The width is decided by the parent, while the
	 * height is decided by the component.
	 */
	...
	/**
	 * The focus state of the parent. The component cannot have focus, if the parent
	 * doesn't.
	 */
	private final boolean focus;
	/**
	 * Set to false, if another component is in front of another component, at the
	 * current mouse position. Only has meaning if the mouse cursor is hovering over
	 * the component.
	 */
	private final boolean onTop;
	/**
	 * Set to true by the child using {@link #requestFocus()}. Used to indicate that
	 * the focus within the parent should be given to the child component.
	 */
	...
	/**
	 * Constructor that should be used when a parent is calling a method by the
	 * child. {@link #inter} and {@link #onTop} are inherited without modification.
	 *
	 * @param context
	 *            the context of the parent
	 * @param left
	 *            the left horizontal border for the child
	 * @param right
	 *            the right horizontal border for the child
	 * @param offset
	 *            the vertical position of the child relative to the parent's
	 *            position
	 * @param focus
	 *            focus state of the parent
	 * @param onTop
	 *            whether component is in the front
	 */
	 ...
	 * @param focus
	 *            set to false, to disable the component from having focus
	 * @param onTop
	 *            set to false, if a component is above another component at the
	 ...
	 *
	 * @return set to false, if another component is above this component at the
	...
	/**
	 * Used to indicate to the parent that the current component has to have focus
	 * within the parent.
	 */
	 ...
	 *
	 * @return set to true, if mouse is hovering and component isn't below another
	 *         one
	 */
	 ...
	 *
	 * @return set to true, if {@link #isHovered()} is true and the left mouse
	 *         button is clicked
	 */
	 ...
	 *
	 * @return construct a rectangle out of the current component {@link #position}
	 *         and {@link #size}
	 */
