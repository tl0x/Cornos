...
/**
 * Object representing the entire GUI. All components should be a direct or
 * indirect child of this objects.
 *
 * @author lukflug
 */
public class ClickGUI implements PanelManager {
	/**
	 * List of direct child components (i.e. panels). The must all be
	 * {@link FixedComponent}.
	 */
	 ...
	 *            the {@link DescriptionRenderer} used by the GUI
	 */
	...
	public void render() {
		...
		if (focusComponent != null) {
			if (this.components.remove(focusComponent))
	 ...
	 *
	 * @param scancode
	 *            the scancode of the key being typed
	 */
	 ...
	 *
	 * @param config
	 *            the configuration list to be used
	 */
	 ...
	 *            the component
	 * @param highest
	 *            whether this component is on top
	 * @return the context
	 */
	...
	protected interface LoopFunction {
		 ...
		 *            the component
		 */
		void loop(Context context, FixedComponent component);
	}
}
