...
/**
 * Theme corresponding to the appearance GameSense 2.0 and 2.1 had. The
 * parameter gradient in the constructor determines, if it appears like
 * GameSense 2.0-2.1.1 (false) or like GameSense 2.1.2-2.1.5 (true).
 *
 * @author lukflug
 */
    ...
    protected class ComponentRenderer extends RendererBase {
        ...
        public void renderTitle(Context context, String text, boolean focus, boolean active) {
            if (panel)
                ...
                if (active)
                    fontColor = getMainColor(focus, true);
        ...
        public void renderTitle(Context context, String text, boolean focus, boolean active, boolean open) {
            ...
            if (!panel) {
                ...
                Point p1, p2, p3;
                if (open) {
                    p3 = new Point(context.getPos().x + context.getSize().width - 2,
                    ...
                    p1 = new Point(context.getPos().x + context.getSize().width - context.getSize().height + 2,
                            context.getPos().y + context.getSize().height / 4);
                } else {
