...
/**
 * Implementation of {@link ColorScheme} using {@link ColorSetting} and
 * {@link NumberSetting}.
 *
 * @author lukflug
 */
public class SettingsColorScheme implements ColorScheme {
	 ...
	 *            opacity setting
	 */
	public SettingsColorScheme(ColorSetting activeColor, ColorSetting inactiveColor, ColorSetting backgroundColor,
			ColorSetting outlineColor, ColorSetting fontColor, NumberSetting opacity) {
