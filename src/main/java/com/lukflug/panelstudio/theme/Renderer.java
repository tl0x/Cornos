...
public interface Renderer {
	 ...
	 *
	 * @param open
	 *            true if the component in question the the title bar for an open
	 *            container
	 * @return the component height
	 */
	int getHeight(boolean open);
	 ...
	 *
	 * @param scroll
	 *            whether the container was restricted due to scrolling
	 * @return the horizontal border
	 */
	int getLeftBorder(boolean scroll);
	 ...
	 * @return the horizontal border
	 */
	int getRightBorder(boolean scroll);

	/**
	 * Render the title bar for a component, while deciding whether to render an
	 * active or inactive title bar.
	 *
	 * @param context
	 ...
	 * @param focus
	 *            the focus state for the component
	 */
	void renderTitle(Context context, String text, boolean focus);
	 ...
	 */
	void renderTitle(Context context, String text, boolean focus, boolean active);
	 ...
	 */
	void renderTitle(Context context, String text, boolean focus, boolean active, boolean open);
	 ...
	 *            whether the component is active or inactive
	 * @param rectangle
	 *            the rectangle defining the title bar
	 * @param overlay
	 *            whether to render mouse hover overlay
	 */
	void renderRect(Context context, String text, boolean focus, boolean active, Rectangle rectangle, boolean overlay);
	 ...
	 *            the focus state for the component
	 */
	void renderBackground(Context context, boolean focus);
	 ...
	 *            whether the container is open or closed
	 */
	void renderBorder(Context context, boolean focus, boolean active, boolean open);

	/**
	 * Renders the scroll bar for a container
	 *
	 * @param context
	 *            context the {@link Context} for the component
	 * @param focus
	 *            the focus state for the component
	 * @param active
	 *            whether the component is active or inactive
	 * @param scroll
	 *            whether the container has scrolling active
	 * @param childHeight
	 ...
	 */
	int renderScrollBar(Context context, boolean focus, boolean active, boolean scroll, int childHeight,
			int scrollPosition);
	...
	/**
	 * Overrides the default color scheme. {@link #restoreColorScheme()} should
	 * always be called after rendering using a custom color scheme is finished.
	 *
	 * @param scheme
	 *            the custom color scheme
	 */
	void overrideColorScheme(ColorScheme scheme);
