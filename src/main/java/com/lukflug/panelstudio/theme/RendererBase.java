...
public abstract class RendererBase implements Renderer {
	...
	/**
	 * Renders using
	 * {@link #renderRect(Context, String, boolean, boolean, java.awt.Rectangle, boolean)}
	 * with the rectangle being specified by {@link Context#getRect()}.
	 */
	@Override
	...
	/**
	 * Renders a title bar using
	 * {@link #renderTitle(Context, String, boolean, boolean)}.
	 */
	@Override
	...
	/**
	 * Returns the default color scheme, if {@link #scheme} is null, otherwise
	 * returns {@link #scheme}.
	 *
